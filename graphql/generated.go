...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Post.postedOn":
		if e.complexity.Post.PostedOn == nil {
			break
		}
...
func (ec *executionContext) field_Mutation_share_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["post"]; ok {
		arg0, err = ec.unmarshalNNewPost2githubᚗcomᚋmainawycliffeᚋgoᚑgraphqlᚑnewsᚑfeedᚑsubscriptionᚋgraphqlᚐNewPost(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_share(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().Share(rctx, args["post"].(NewPost))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	return ec.marshalNPost2ᚖgithubᚗcomᚋmainawycliffeᚋgoᚑgraphqlᚑnewsᚑfeedᚑsubscriptionᚋgraphqlᚐPost(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Post_link(ctx context.Context, field graphql.CollectedField, obj *Post) (ret graphql.Marshaler) {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
...
func (ec *executionContext) _Post(ctx context.Context, sel ast.SelectionSet, obj *Post) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "postedOn":
			out.Values[i] = ec._Post_postedOn(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) unmarshalNNewPost2githubᚗcomᚋmainawycliffeᚋgoᚑgraphqlᚑnewsᚑfeedᚑsubscriptionᚋgraphqlᚐNewPost(ctx context.Context, v interface{}) (NewPost, error) {
	return ec.unmarshalInputNewPost(ctx, v)
}

func (ec *executionContext) marshalNPost2githubᚗcomᚋmainawycliffeᚋgoᚑgraphqlᚑnewsᚑfeedᚑsubscriptionᚋgraphqlᚐPost(ctx context.Context, sel ast.SelectionSet, v Post) graphql.Marshaler {
	return ec._Post(ctx, sel, &v)
}

func (ec *executionContext) marshalNPost2ᚕᚖgithubᚗcomᚋmainawycliffeᚋgoᚑgraphqlᚑnewsᚑfeedᚑsubscriptionᚋgraphqlᚐPost(ctx context.Context, sel ast.SelectionSet, v []*Post) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNPost2ᚖgithubᚗcomᚋmainawycliffeᚋgoᚑgraphqlᚑnewsᚑfeedᚑsubscriptionᚋgraphqlᚐPost(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNPost2ᚖgithubᚗcomᚋmainawycliffeᚋgoᚑgraphqlᚑnewsᚑfeedᚑsubscriptionᚋgraphqlᚐPost(ctx context.Context, sel ast.SelectionSet, v *Post) graphql.Marshaler {
	if v == nil {
		if !ec.HasError(graphql.GetResolverContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
